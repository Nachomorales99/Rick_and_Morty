						...
						<div className="row">
							<div className="col-sm-12 col-md-6">
								...
								<p className="text-justify">
									...
									una interfaz divertida para conocer todos los personajes de
									esta genial serie de televisión creada por Dan Harmon. ¡Que se
									diviertan!
								</p>
							</div>
						...
						<div className="row">
							<div className="col-md-8 col-sm-6 col-xs-12">
								<p className="copyright-text">
									Copyright &copy; 2023 Juan Ignacio Morales. All Rights
									Reserved
								</p>
							</div>
